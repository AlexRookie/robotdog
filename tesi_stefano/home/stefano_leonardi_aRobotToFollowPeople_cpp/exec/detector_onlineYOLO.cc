/** @file   detector_onlineYOLO.cc
 *  @brief  A working example of object detection with the YOLO algorithm.
 *  @author Stefano Leonardi
 ***********************************************/
// Usage example:  ./object_detection_yolo.out --video=run.mp4
//                 ./object_detection_yolo.out --image=bird.jpg
// ./build/buildLinux/detectorOnlineYOLO --image=imagesIn/samplePeople/soccer.jpg
// cls && ./compile.sh && 
#include <fstream>
#include <sstream>
#include <iostream>
 ...
 *  \param[in, out] frame The image to be transformed with the predicted Boundig Boxes.
 *  \param[in] detections The detections to be filtered.
 */
void postprocess(Mat & frame, const vector<Mat> & detections);
...
int main(int argc, char** argv){
    ...
    String modelConfiguration = "./models/yoloV3-coco/yolov3.cfg";
    ...
    try {
        ...
        // Open the webcaom
            ...
            cout << "The device is: " << parser.get<int>("device") << endl;
    ...
    while (waitKey(1) < 0){
        ...
        // vector<String> v = getOutputsNames(net);
