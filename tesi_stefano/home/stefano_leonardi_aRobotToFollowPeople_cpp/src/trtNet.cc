...
namespace trtnet {
    ...
    void TrtGooglenet::_initEngine(std::string filePath)
    {
	    ...
	    _binding_prob = _engine->getBindingIndex("pool5/7x7_s1");
        my_assert(_engine->bindingIsInput(_binding_prob) == false, "bad type of binding 'pool5/7x7_s1'");
    ...
    void TrtGooglenet::initEngine(std::string filePath, int dataDims[3], int probDims[3])
    {
        ...
        my_assert(d.nbDims == 3, "bad nbDims for 'pool5/7x7_s1'");
        my_assert(d.c() == probDims[0] && d.h() == probDims[1] && d.w() == probDims[2], "bad dims for 'pool5/7x7_s1'");
        ...
        my_assert(d.nbDims == 3, "bad nbDims for 'pool5/7x7_s1'");
        my_assert(d.d[0] == probDims[0] && d.d[1] == probDims[1] && d.d[2] == probDims[2], "bad dims for 'pool5/7x7_s1'");
